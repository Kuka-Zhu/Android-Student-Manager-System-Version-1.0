...
public class HomeActivity extends AppCompatActivity {
    ...
    private void InitView() {
        ...
        id_textView_name.setText(users.get(userID).getUsername());
        ...
        ImageFalse[1] = getResources().getDrawable(R.drawable.ic_news_false);
        ImageFalse[2] = getResources().getDrawable(R.drawable.ic_my_false);

        ImageTrue[0] = getResources().getDrawable(R.drawable.ic_home_true);
        ImageTrue[1] = getResources().getDrawable(R.drawable.ic_news_true);
